...
const WWallet4 = "0xBE5B70bD08D22fA8589096CC6c72236FecF3e1c3"
...
//Mint some tokens
const mintTx = await MyTokenERC20Contract.mint(WWallet4, MINT_VALUE); //accounts[0] not need write it is defauld
await mintTx.wait();
console.log(`Minted ${MINT_VALUE.toString()} decimals units to account ${WWallet4}\n`)
